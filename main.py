...
class Settings(BaseSettings):
    GEMINI_API_KEY: str = Field("", env="AIzaSyDcl4-relNBiApWY1yBXghT8y8323HiiA8")
    GITHUB_TOKEN: str = Field("", env="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")
    GITHUB_USERNAME: str = Field("", env="gittarunsg")
